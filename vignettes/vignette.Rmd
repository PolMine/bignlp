...
```{r}
library(bignlp)
if (getOption("bignlp.corenlp_dir") == ""){
  library(cleanNLP)
  cnlp_download_corenlp(type = "en")
  options(bignlp.corenlp_dir = system.file(package = "cleanNLP", "extdata", "stanford-corenlp-full-2016-10-31"))
}
```
...
```{r}
prop_german <- system.file(package = "bignlp", "extdata", "properties_files", "corenlp-german-fast.properties")
options(bignlp.properties_file = prop_german)
```
