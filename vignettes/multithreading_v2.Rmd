---
title: "A new take on multithreading"
author: "Andreas Blaette (andreas.blaette@uni-due.de)"
date: "`r Sys.Date()`"
output: rmarkdown::html_vignette
vignette: >
  %\VignetteIndexEntry{multithreading2}
  ...
  function(i){
    ...
    rbindlist(
      lapply(
        1:nrow(dt_chunks[[i]]),
        function(j){
          corenlp_parse_json(input = file.path(tagdir, i, sprintf("%d.txt.json", dt_chunks[[i]][["id"]][[j]])))
        }
      )
    )
  }  
